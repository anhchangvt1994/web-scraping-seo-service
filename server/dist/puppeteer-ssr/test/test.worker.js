"use strict"; function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }var _puppeteercore = require('puppeteer-core'); var _puppeteercore2 = _interopRequireDefault(_puppeteercore);
	...
	if (path) {
		try {
			await _optionalChain([_workerpool2.default, 'access', _ => _.pool, 'call', _2 => _2(
				_path.resolve.call(void 0, __dirname, '../utils/FollowResource.worker/index.ts')
