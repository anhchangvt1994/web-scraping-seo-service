...
const ISRHandler = async (params) => {
		...
		if (browser && browser.connected) {
			...
			try {
				...
				_optionalChain([safePage, 'call', _53 => _53(), 'optionalAccess', _54 => _54.on, 'call', _55 => _55('request', async (req) => {
					...
					if (resourceType === 'stylesheet') {
						...
						if (resourceType === 'document' && reqUrl.startsWith(baseUrl)) {
							...
							const pointsTo = _optionalChain([_serverconfig2.default, 'access', _56 => _56.routes, 'optionalAccess', _57 => _57[urlInfo.pathname], 'optionalAccess', _58 => _58.pointsTo])
				...
				try {
					...
					status = _nullishCoalesce(_optionalChain([response, 'optionalAccess', _59 => _59.status, 'optionalCall', _60 => _60()]), () => ( status))
				...
				_optionalChain([safePage, 'call', _61 => _61(), 'optionalAccess', _62 => _62.close, 'call', _63 => _63()])
				if (params.hasCache) {
					cacheManager.rename({
						url,
					})
			...
			if (_constants3.CACHEABLE_STATUS_CODE[status]) {
				try {
					html = await _asyncNullishCoalesce((await _optionalChain([safePage, 'call', _64 => _64(), 'optionalAccess', _65 => _65.content, 'call', _66 => _66()])), async () => ( '')) // serialized HTML of page DOM.
					_optionalChain([safePage, 'call', _67 => _67(), 'optionalAccess', _68 => _68.close, 'call', _69 => _69()])
				} catch (err) {
					_ConsoleHandler2.default.log('ISRHandler line 315:')
					_ConsoleHandler2.default.error(err)
					_optionalChain([safePage, 'call', _70 => _70(), 'optionalAccess', _71 => _71.close, 'call', _72 => _72()])
					if (params.hasCache) {
						cacheManager.rename({
							url,
						})
	...
	if (_constants3.CACHEABLE_STATUS_CODE[status]) {
		...
		const crawlCustomOption = _optionalChain([_serverconfig2.default, 'access', _73 => _73.crawl, 'access', _74 => _74.custom, 'optionalCall', _75 => _75(url)])
