 ...
 const getUrl = (req) => {
  ...
  const pathname = (() => {
    ...
    if (req.headers["redirect"])
      tmpPathName = _optionalChain([JSON, 'access', _3 => _3.parse, 'call', _4 => _4(req.headers["redirect"] ), 'optionalAccess', _5 => _5.path]);

    return _optionalChain([(tmpPathName || req.url), 'optionalAccess', _6 => _6.split, 'call', _7 => _7("?"), 'optionalAccess', _8 => _8[0]]);
  })();
