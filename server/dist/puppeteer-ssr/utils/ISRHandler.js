...
const waitResponse = (() => {
	...
	const maximumTimeout =
		_constants.BANDWIDTH_LEVEL > _constants.BANDWIDTH_LEVEL_LIST.ONE ? 10000 : 10000
...
const ISRHandler = async (params) => {
	...
	if (
		...
		if (browser && browser.connected) {
			...
			try {
				...
				await _optionalChain([safePage, 'call', _35 => _35(), 'optionalAccess', _36 => _36.setViewport, 'call', _37 => _37({
					width: _constants3.WINDOW_VIEWPORT_WIDTH,
					height: _constants3.WINDOW_VIEWPORT_HEIGHT,
				})])
				await _optionalChain([safePage, 'call', _38 => _38(), 'optionalAccess', _39 => _39.setRequestInterception, 'call', _40 => _40(true)])
				_optionalChain([safePage, 'call', _41 => _41(), 'optionalAccess', _42 => _42.on, 'call', _43 => _43('request', (req) => {
				...
				await _optionalChain([safePage, 'call', _44 => _44(), 'optionalAccess', _45 => _45.setExtraHTTPHeaders, 'call', _46 => _46({
					...specialInfo,
					service: 'puppeteer',
				})])
			...
			try {
				...
				_ConsoleHandler2.default.error(err)
				_optionalChain([safePage, 'call', _58 => _58(), 'optionalAccess', _59 => _59.close, 'call', _60 => _60()])
				browser.emit('closePage', url)
				if (!isMainThread) {
					parentPort.postMessage({
						name: 'closePage',
	...
	if (_constants3.CACHEABLE_STATUS_CODE[status]) {
		...
		const enableToOptimize =
			(_optionalChain([_serverconfig2.default, 'access', _61 => _61.crawl, 'access', _62 => _62.routes, 'access', _63 => _63[pathname], 'optionalAccess', _64 => _64.optimize]) ||
				_optionalChain([_serverconfig2.default, 'access', _65 => _65.crawl, 'access', _66 => _66.custom, 'optionalCall', _67 => _67(pathname), 'optionalAccess', _68 => _68.optimize]) ||
				_serverconfig2.default.crawl.optimize) &&
			enableOptimizeAndCompressIfRemoteCrawlerFail

		const enableToCompress =
			(_optionalChain([_serverconfig2.default, 'access', _69 => _69.crawl, 'access', _70 => _70.routes, 'access', _71 => _71[pathname], 'optionalAccess', _72 => _72.compress]) ||
				_optionalChain([_serverconfig2.default, 'access', _73 => _73.crawl, 'access', _74 => _74.custom, 'optionalCall', _75 => _75(pathname), 'optionalAccess', _76 => _76.compress]) ||
				_serverconfig2.default.crawl.compress) &&
			enableOptimizeAndCompressIfRemoteCrawlerFail

		let isRaw = false
		try {
			if (enableToOptimize) html = await _OptimizeHtmlworker.shallowOptimizeContent.call(void 0, html)

			if (enableToOptimize) html = await _OptimizeHtmlworker.deepOptimizeContent.call(void 0, html)
