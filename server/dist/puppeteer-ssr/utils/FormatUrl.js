...
var _serverconfig = require('../../server.config'); var _serverconfig2 = _interopRequireDefault(_serverconfig);
 ...
 const getUrl = (req) => {
  ...
  const pathname = (() => {
    ...
    if (req.headers["redirect"])
      tmpPathName = _optionalChain([JSON, 'access', _5 => _5.parse, 'call', _6 => _6(req.headers["redirect"] ), 'optionalAccess', _7 => _7.path]);

    return _optionalChain([(tmpPathName || req.url), 'optionalAccess', _8 => _8.split, 'call', _9 => _9("?"), 'optionalAccess', _10 => _10[0]]);
  })();
 ...
 const getPathname = (req) => {
  ...
  const pathname = (() => {
    let tmpPathName;
    if (req.headers["redirect"])
      tmpPathName = _optionalChain([JSON, 'access', _11 => _11.parse, 'call', _12 => _12(req.headers["redirect"] ), 'optionalAccess', _13 => _13.path]);

    return _optionalChain([(tmpPathName || req.url), 'optionalAccess', _14 => _14.split, 'call', _15 => _15("?"), 'optionalAccess', _16 => _16[0]]);
  })();
