...
const compressContent = (html) => {
	if (!html) return ''
	else if (_constants3.DISABLE_COMPRESS_HTML || _constants.POWER_LEVEL === _constants.POWER_LEVEL_LIST.ONE)
		return html
...
const optimizeContent = (html, isFullOptimize = false) => {
	...
	if (_constants3.DISABLE_DEEP_OPTIMIZE || _constants.POWER_LEVEL === _constants.POWER_LEVEL_LIST.ONE) return html
