...
,
				...
				const { enableToCrawl, enableToCache } = (() => {
					...
					const crawlOptionPerRoute =
						...
						_optionalChain([_serverconfig2.default, 'access', _14 => _14.crawl, 'access', _15 => _15.custom, 'optionalCall', _16 => _16(pathname)])
				...
				if (headers.accept === 'application/json') {
					...
					const apiStoreData = await (async () => {
						...
						const cookies = _CookieHandler.getCookieFromResponse.call(void 0, res)
						const deviceType = _optionalChain([cookies, 'optionalAccess', _17 => _17['DeviceInfo'], 'optionalAccess', _18 => _18['type']])
