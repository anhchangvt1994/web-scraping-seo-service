...
if (!_fs2.default.existsSync(_constants.storePath)) {
 ...
 const getData = async (key, options) => {
	...
	try {
		result = await exports.get.call(void 0, _constants.dataPath, key, 'br', options)
 ...
 const getStore = async (
	...
	try {
		result = await exports.get.call(void 0, _constants.storePath, key, 'json', options)
 ...
 const setData = async (
	...
	try {
		result = await exports.set.call(void 0, _constants.dataPath, key, 'br', content, options)
	} catch (err) {
		_ConsoleHandler2.default.error(err)
	}
 ...
 const setStore = async (key, content) => {
	...
	try {
		result = await exports.set.call(void 0, _constants.storePath, key, 'json', content, {
			isCompress: false,
		})
	} catch (err) {
		_ConsoleHandler2.default.error(err)
 ...
 const removeStore = async (key) => {
	...
	try {
		result = await exports.remove.call(void 0, _constants.storePath, key, 'json')
	} catch (err) {
		_ConsoleHandler2.default.error(err)
	}
