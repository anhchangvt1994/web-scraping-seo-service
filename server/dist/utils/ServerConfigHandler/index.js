					...
					if (serverConfigDefined[key].routes[localeRouteKey]) {
						serverConfigDefined[key].routes[localeRouteKey] = {
							...
							cache: {
								...
								renewTime:
									_nullishCoalesce(_optionalChain([serverConfigDefined, 'access', _13 => _13[key], 'access', _14 => _14.routes, 'access', _15 => _15[localeRouteKey], 'access', _16 => _16.cache
, 'optionalAccess', _17 => _17.renewTime]), () => ( _constants.defaultServerConfig[key].cache.renewTime)),
							},
						}
					} else
						serverConfigDefined[key].routes[localeRouteKey] =
		...
		if (key === 'api') {
			if (options[key]) {
				...
				serverConfigDefined[key] = {
					list: tmpOptionCastingType.list || _constants.defaultServerConfig[key].list,
				}
